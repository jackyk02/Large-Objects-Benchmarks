...
} _serverupdated_parameters_port0_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
} _serverupdated_parameters_port1_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
} _serverupdated_parameters_port2_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
} _serverupdated_parameters_port3_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
} _serverupdated_parameters_port_t;
#endif
